...
**Endpoint:** `GET https://app-bojrafz0d6v5-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-bojrafz0d6v5-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
